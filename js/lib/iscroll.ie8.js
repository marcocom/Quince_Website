...
define(["notJquery"], function($) {
    ...
    var isLegacyIE = (document.all && !document.addEventListener)? true : false;
    ...
    var IScroll = (function (window, document, Math) {
        ...
        var utils = (function () {
            ...
            me.addEvent = function (el, type, fn, capture) {
                ...
                var self = this,
                    tmpElm = (el || this.scroller);
                //console.log("capture ", capture);
                //console.log("_bind ",type, el, bubble);

                if (!isLegacyIE) {
                    tmpElm.addEventListener(type, fn, !!capture);
                } else {
                    //console.log(tmpElm);
                    // Store function so we can detachEvent later.
                    if(tmpElm === window) tmpElm = document;
                    if(type == "touchstart" || type == "MSPointerDown")return;
                    events[type] = function(e) {

                        fn.handleEvent.call(fn, e);
                    };

                    /*$(el).bind(type, function(evt){
                     fn.handleEvent.call(fn, evt);
                     });*/

                    tmpElm.attachEvent('on' + type, events[type]);
                }
            };
            ...
            me.removeEvent = function (el, type, fn, capture) {
                ...
                //console.log("_bind ",type, el, bubble);
                if (!isLegacyIE) {
                    tmpElm.removeEventListener(type, fn, !!capture);
                } else {
                    // Store function so we can detachEvent later.

                    /*$(el).unbind(type, function(evt){
                     fn.handleEvent.call(fn, evt);
                     });*/
                    if(tmpElm === window) tmpElm = document;
                    if (events[type]) {
                        tmpElm.detachEvent('on' + type, events[type]);
                    }
                }
            };
...
// INSERT POINT: _init
            ...
            _start: function (e) {
                ...
                //console.log(" utils.eventType[e.type]: ", utils.eventType[e.type], "e.type: ", e.type);
                ...
                this.pointX = (point.pageX || point.clientX + docBody.scrollLeft + docEl.scrollLeft);
                this.pointY = (point.pageY || point.clientY + docBody.scrollTop + docEl.scrollTop);

                this._execEvent('scrollStart');
            },

            _move: function (e) {
                //var tmpType = (e.type)? e.type : e.type..substring(0, 1);
                //console.log("this.enabled",this.enabled, "e.type: ",e.type, "type: ", utils.eventType[e.type], "initiated: ", this.initiated);
                ...
                //deltaY		= this.hasVerticalScroll   ? point.pageY - this.pointY : 0,
                    tmpPageX = (point.pageX || point.clientX + docBody.scrollLeft + docEl.scrollLeft),
                    tmpPageY = (point.pageY || point.clientY + docBody.scrollTop + docEl.scrollTop),
                    deltaX	= this.hasHorizontalScroll ? tmpPageX - this.pointX : 0,
                    deltaY	= this.hasVerticalScroll   ? tmpPageY - this.pointY : 0,
                //deltaX		= this.isScrollbarDragged ? -(tmpPageX - this.pointX) * (this.scrollerWidth / this.wrapperWidth) : tmpPageX - this.pointX,
                //deltaY		= this.isScrollbarDragged  ? -(tmpPageY - this.pointY) * (this.scrollerHeight / this.wrapperHeight) : tmpPageY - this.pointY,
                    timestamp	= utils.getTime(),
                    newX, newY,
                    absDistX, absDistY;

                this.pointX		= tmpPageX;
                this.pointY		= tmpPageY;
                ...
                //console.log("blah: ", deltaX, " tmpPageX: ",tmpPageX, " this.pointX: ",this.pointX);
...
// INSERT POINT: _transitionTimingFunction
            ...
            _translate: function (x, y) {
                ...
                //console.log("this.scrollerStyle ", this.scrollerStyle);
                ...
                if ( this.options.useTransform ) {
                    ...
                    //console.log("this.scrollerStyle[utils.style.transform] ",this.scrollerStyle[utils.style.transform]);
                    ...
                    x = Math.round(x);
                    y = Math.round(y);
                    //console.log("x ", x, this.scrollerStyle, " this.scrollerStyle: ", $(this.scrollerStyle).attr("id"));
...
// INSERT POINT: _wheel
        ...
        function createDefaultScrollbar (direction, interactive, type) {
            ...
            indicator.setAttribute('data-scrollbarindicator', true);
        ...
        Indicator.prototype = {
            ...
            _start: function (e) {
                ...
                this.initiated = true;
                this.moved = false;
                this.lastPointX	= tmpPageX;
                this.lastPointY	= tmpPageY;
            ...
            _move: function (e) {
                ...
                deltaX = tmpPageX - this.lastPointX;
                this.lastPointX = tmpPageX;

                //deltaY = point.pageY - this.lastPointY;
                deltaY = tmpPageY - this.lastPointY;
                this.lastPointY = tmpPageY;
            ...
            refresh: function () {
                ...
                if ( this.options.listenX ) {
                    ...
                    if ( this.options.resize ) {
                        ...
                        this.indicatorStyle.width = 70 + 'px';
                    } else {
                        this.indicatorWidth = this.indicator.clientWidth;
                    }
                    this.maxPosX = this.wrapperWidth - this.indicatorWidth+222;
                    this.sizeRatioX = this.options.speedRatioX || (this.scroller.maxScrollX && (this.maxPosX / this.scroller.maxScrollX));
                    //console.log("this.sizeRatioX ", this.sizeRatioX);
                }
            ...
            updatePosition: function () {
                console.log("this.sizeRatioX * this.scroller.x", this.sizeRatioX , " | ", this.scroller.x);
                ...
                if(isLegacyIE && this.lastPointX && this.initiated){
                    x=this.lastPointX-700;
                }
